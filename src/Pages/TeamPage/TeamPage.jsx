                                ...
                                <Link to='/detailsRearch'>
                                    <div className='lg:flex gap-6 lg:space-y-0 space-y-4 cursor-pointer'>
                                        ...
                                        <div className='lg:w-3/4 w-full group'>
                                            <h2 className='text-2xl font-semibold text-[#F46957]'>{member.name}</h2>
                                            <p className='py-1'><span>{member.designation}</span></p>
                                            <p>{member.description.slice(0, 200)}...<span className='text-lg font-medium group-hover:text-[#F46957] duration-300'>[read more]</span></p>
                                            <div className='py-1 flex items-center space-x-4'>
                                                <p><span className='font-bold'>Social Link:</span></p>
