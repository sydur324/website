...
const PopularJournals = () => {
    ...
    const popular = jounrals.filter((jounral) => jounral.category === 'popular')
    return (
        <div className="xl:px-20 lg:px-16 md:px-14 sm:px-12 px-12 py-12">
            <div className="lg:flex items-center lg:gap-0 gap-6 lg:justify-between justify-center lg:text-left text-center">
                <div>
                    ...
                    <h2 className="text-2xl font-bold">Our Popular Journals</h2>
            ...
            <div className="py-8 card-dots">
                <Slider   {...settings}>
                    {
                        popular.map((jounral, index) => <Card key={jounral.index} jounral={jounral} >
