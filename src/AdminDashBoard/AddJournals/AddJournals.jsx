...
const AddJournals = () => {
    ...
    return (
        <div className="px-12 py-8 w-4/5">
            <h2 className="py-2 px-4 border font-bold text-sm">Admin Journal Add Page</h2>

            <div className="border my-6">
                <h2 className="py-3 text-center bg-[#F46957] text-white font-bold">Journal Information</h2>

                <div className="my-8 px-4">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                        <div className="flex flex-col space-y-1">
                            <label className="font-bold text-sm">Title of Journal:</label>
                            <input {...register("title")} className="px-2 py-2 border outline-none" type="text" placeholder="Enter Journal Title.." />
                        </div>
